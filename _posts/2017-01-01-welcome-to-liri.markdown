...
As a result, [Hawaii](http://hawaiios.org) and [Papyros](http://papyros.io) are now discontinued and continue under the name Anima.

Anima upcoming release is version 0.9.0 because it continues where [Hawaii](http://hawaiios.org) left off.
...
[Green Island](https://github.com/greenisland/greenisland) the Wayland compositor will stick around for a little while, for Anima 0.9.0 to be precise. With Anima 0.10.0 we will replace it with the new [Wayland libraries](https://github.com/lirios/wayland). Patches to [Green Island](https://github.com/greenisland/greenisland) are no longer accepted at this point.
